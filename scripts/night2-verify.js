...
// 사용: node scripts/night2-verify.js <base>   base = file:///home/user/ulsan2 또는 https://ulsanc.pages.dev
'use strict';
...
const BASE = process.argv[2] || 'https://ulsanc.pages.dev';
  ...
  for (const p of PAGES) {
    ...
    for (const v of VIEWPORTS) {
      ...
      rows.push({
        ...
        canonicalSelf: d.canonical.replace(/\?.*/, '') === `https://ulsanc.pages.dev/night/${p.slug}/`,

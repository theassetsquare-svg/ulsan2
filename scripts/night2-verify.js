...
// 사용: node scripts/night2-verify.js <base>   base = file:///home/user/ulsan2 또는 https://ulsang.pages.dev
'use strict';
...
const BASE = process.argv[2] || 'https://ulsang.pages.dev';
  ...
  for (const p of PAGES) {
    ...
    for (const v of VIEWPORTS) {
      ...
      rows.push({
        ...
        canonicalSelf: d.canonical.replace(/\?.*/, '') === `https://ulsang.pages.dev/night/${p.slug}/`,
